...
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('Adidas',30000,28000,1);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('BlackBarrys',50000,45000,1);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('Nike',35000,33000,1);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('Puma',40000,35000,1);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('Levis',55000,50000,1);

insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('HUGO',65000,55000,2);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('POLO',55000,50000,2);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('EMPORIO ARMAMNI',55000,50000,2);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('GUESS',35000,32000,2);
insert into product_tbl(name,retailPrice,wholeSalePrice,category_id) values('Levis',75000,70000,2);
